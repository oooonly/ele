  ...
  <div class="food" v-show="showFlag" ref="food">
    <div class="food-content">
      ...
      <div class="rating">
        ...
        <ratingselect :selectType="selectType" :onlyContent="onlyContent" :desc="desc" :ratings="food.ratings" @selectTypeChange="selectTypeChange" @onlyContentChange="onlyContentChange"></ratingselect>
